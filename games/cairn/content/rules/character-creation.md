...
- First, roll or choose from the Backgrounds table below. You will refer to that background for the next few steps.
...
- Roll for the rest of your character's Traits, and then on the Bonds table.
...
- Roll 1d6 to determine your PC's starting Hit Protection (HP), which reflects their ability to avoid damage in combat. It does not indicate a character's health or fortitude, nor do they lose it for very long. See [Healing & Recovery](../core-rules/#healing--recovery).
- If an attack would take a PC's HP exactly to 0, the player must roll on the [Scars](../core-rules/#scars) table.
