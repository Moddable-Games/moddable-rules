...
| d6 | Result | Effect |
|---|---|---|
| 1 | Encounter | Roll on an encounter table. Possibly hostile. (See [Reactions](../core-rules/#reactions).) |
...
| d6 | Result | Effect |
|---|---|---|
| 1 | Encounter | Roll on an encounter table for that terrain type or location. Don't forget to roll for NPC [reactions](../core-rules/#reactions) if applicable. |
