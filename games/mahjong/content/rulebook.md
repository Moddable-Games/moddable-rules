...
unsupported:
  _family: "The tableau plugin (moddable-engine#184) plays Hong Kong mahjong from its frontmatter (`game: wall`): the wall, claiming discards out of turn, kongs and robbing them, flowers, and faan scoring. The games below need scoring of their own on the same wall."
