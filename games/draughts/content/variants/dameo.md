...
- **Delayed removal:** Captured pieces are removed at the **end of the entire multi-capture sequence**, not after each individual jump. A piece that has been jumped but not yet removed still physically blocks the line — it cannot be jumped again in the same sequence.
