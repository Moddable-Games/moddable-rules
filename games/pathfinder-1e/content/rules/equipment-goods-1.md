---
title: "Adventuring Gear, Substances & Tools"
slug: equipment-goods-1
parent: pathfinder-1e
published: true
---

## Adventuring Gear, Substances & Tools

This page covers adventuring gear, alchemical substances and items, and tools and skill kits. See Weapons and Armor for combat equipment, and Clothing, Mounts & Services for the remaining goods categories.
...
The standard hourglass takes 1 hour to empty the sand from the upper chamber.
...
Temples to good deities sell holy water at cost (making no profit). Holy water is made using the _bless water_ spell.
...
An unholy symbol is like a holy symbol except that it focuses negative energy and is used by evil clerics (or by neutral clerics who want to cast evil spells or channel negative energy).
