...
**Prerequisites:** 
Weapon Focus, proficiency with the selected weapon.
...
**Prerequisites:** 
Improved Bull Rush, Power Attack, base attack bonus +6, Str 13.
...
**Prerequisites:** 
Combat Expertise, Improved Feint, base attack bonus +6, Int 13.
...
**Prerequisites:** 
Improved Grapple, Improved Unarmed Strike, base attack bonus +6, Dex 13.
...
**Prerequisites:** 
Improved Overrun, Power Attack, base attack bonus +6, Str 13.
...
**Prerequisites:** 
Shield Focus, Shield Proficiency, base attack bonus +1, 8th-level fighter.
...
**Prerequisites:** 
Improved Sunder, Power Attack, base attack bonus +6, Str 13.
...
**Prerequisites:** 
Combat Expertise, Improved Trip, base attack bonus +6, Int 13.
...
**Prerequisites:** 
Improved Vital Strike, Vital Strike, base attack bonus +16.

**Benefits:** 
When you use the attack action, you can make one attack at your highest base attack bonus that deals additional damage. Roll the weapon's damage dice for the attack four times and add the results together before adding bonuses from Strength, weapon abilities (such as _flaming_), precision based damage, and other damage bonuses. These extra weapon damage dice are not multiplied on a critical hit, but are added to the total.
...
**Normal:** 
See the normal rules on the effects of cover and concealment in Combat.
...
**Normal:** 
Without this feat, a character that performs a shield bash loses the shield's shield bonus to AC until his next turn (see Equipment).
...
**Benefits:** 
When you use the attack action, you can make one attack at your highest base attack bonus that deals additional damage. Roll the weapon's damage dice for the attack three times and add the results together before adding bonuses from Strength, weapon special abilities (such as _flaming_), precision based damage, and other damage bonuses. These extra weapon damage dice are not multiplied on a critical hit, but are added to the total.
...
**Benefits:** 
When you use the attack action, you can make one attack at your highest base attack bonus that deals additional damage. Roll the weapon's damage dice for the attack twice and add the results together before adding bonuses from Strength, weapon abilities (such as _flaming_), precision based damage, and other damage bonuses. These extra weapon damage dice are not multiplied on a critical hit, but are added to the total.
