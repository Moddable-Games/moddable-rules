  ...
  plugins:
    chess:
      ...
      regions:
        ...
        # "Across the river" is the far bank, which is a different bank for each
        # side, and the last rank likewise.
        acrossRiver: { rows: [[0, 2], [4, 6]] }
        lastRank: { rows: [[0, 0], [6, 6]] }
      terrain:
        drown:
          rows: [3, 3]
          immune: [crocodile]
      ...
      pieces:
        ...
        # "Pawns move and capture both straight and diagonally forward. Across
        # the river a pawn may also move one or two squares straight back,
        # without the right to capture or jump." Not a chess pawn in any
        # respect: it captures the way it moves, has no two-square first move,
        # and gains a retreat once it has crossed.
        pawn:
          directional: true
          type: positional
          cases:
