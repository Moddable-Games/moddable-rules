...
related:
  ...
  - standard-dice
unsupported:
  _family: "The tableau plugin (moddable-engine#176) plays a game whose frontmatter names its shape under `plugins.standard-52.game`: climbing (Big 2, and President played to a full finishing order), war, trick-taking (Whist, Hearts, Spades), shedding (Crazy Eights) patience (Klondike, FreeCell, Spider), laying (Rummy), knocking (Gin Rummy) and partnership melds (Canasta). A seat holds its hand privately and sees only the backs of the others. The games below need a shape of play that has not been written."
