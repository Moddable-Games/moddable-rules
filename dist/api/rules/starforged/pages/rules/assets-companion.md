...
- When you ride your banshee as you Undertake an Expedition or Set a Course, you may roll +its health.
...
- When you Strike aided by the bot, add +1; if you Clash, take +1 momentum on a hit.
...
- When you Secure an Advantage by studying the glowcat's reactions in a charged interaction, add +its health.
...
- When you are aided by the bot as you make a move in a formal social interaction, add +1. On a strong hit with a match, you learn something which builds understanding or empathy; also mark 1 tick on your bonds legacy track.
...
Your sidekick has a helpful expertise, chosen when you take this asset.

**Abilities:**

- When you make a move outside of a fight directly aided by their expertise, you may reroll your action die if its value is less than your sidekick's health. If you then score a strong hit with a match, mark 1 tick on your bonds legacy track.
...
- When you make a move by sending it to perform trickery (such as creating a distraction, sneaking into a protected location, or stealing an object) add +its health.
...
- When you Undertake an Expedition (+wits) overland or within a site, add +1.
...
Your utility bot companion has helpful tools at-hand.

**Abilities:**

- When you make a move by directing it to access a system, cut through an obstacle, analyze a mechanical issue, or assemble or disassemble a device, roll +its health and take +1 momentum on a hit. On a strong hit with a match, it reveals an unexpected advantage or insight; take another +1 momentum.
...
- When you Undertake an Expedition, add +1.
