...
There are three categories of vehicles: your command vehicle, support vehicles, and incidental vehicles you acquire during play. This page covers the command vehicle and support vehicle assets. Incidental vehicles are described in Your Character.
...
The command vehicle has an integrity meter and starts at 5 integrity. When your Starship takes a hit, make the Withstand Damage move to see what happens.
...
- When you make a forceful, damaging, or resistant move, you may (after rolling) replace the value of your action die with the rig's integrity; if you do, Lose Momentum (-1).
...
- When you Undertake an Expedition (+edge), take +1 momentum on a hit. On a strong hit with a match, you also surge ahead or find a new path; mark progress.
...
- When you Undertake an Expedition or Set a Course, add +1. When you Finish an Expedition in your rover, you may reroll one challenge die.
...
- When you make a move using the pod's manipulator arms to perform a delicate or forceful task, add +1 and take +1 momentum on a hit.
- When you Face Danger, Gain Ground, or React Under Fire by maneuvering your pod through a hazardous or obstructed area, choose an approach and roll +integrity: careful adds +2 and Loses Momentum (-1), reckless takes +1 momentum on a hit.
...
- When you travel to a location (not your command vehicle), you and your allies may take +1 momentum when you arrive.
...
- When you Undertake an Expedition or Set a Course, you may rely on the skiff's simple durability and roll +integrity. If you do, take +1 momentum on a hit.
...
- When you Enter the Fray, you may roll +integrity; if you do, take +2 momentum on a hit.
