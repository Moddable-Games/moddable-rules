...
This page covers armor and shield categories, how armor affects Armor Class and other statistics, and the full catalog of armor descriptions. See Wealth, Money & Special Materials for currency and crafting materials, Weapons for weapons, and Goods & Services for adventuring gear.
...
This column tells how long it takes to get the armor off. Removing a shield from the arm and dropping it is only a move action.
