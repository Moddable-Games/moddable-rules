## Metamagic, Critical, and Item Creation Feats

This page covers the three smaller core-rulebook feat categories: Metamagic feats (which modify how spells are cast), Critical feats (which add extra effects to critical hits), and Item Creation feats (which let a character craft magic items). 25 feats total, alphabetized within this combined list.
...
**Benefits:** 
You can create magic rods. Crafting a rod takes 1 day for each 1,000 gp in its base price. To craft a rod, you must use up raw materials costing half of its base price. See the magic item creation rules in Magic Items for more information.
