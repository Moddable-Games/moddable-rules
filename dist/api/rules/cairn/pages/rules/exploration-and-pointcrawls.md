## Exploration & Pointcrawls

Warden's Guide material: running dungeon exploration, wilderness exploration, and converting maps into pointcrawls.

### Dungeon Exploration Principles
...
**Freya**: _"I'm going to get a better look at that **statue**. What can I learn without actually getting too close?"_
...
**Freya**: _"I'll quickly put the jewel in my backpack."_
...
#### Wilderness Exploration Example
...
A worked example map illustrating these seven numbered points and their connecting routes accompanies this procedure in the original source; it is not reproduced here as it is an image asset rather than rules text.